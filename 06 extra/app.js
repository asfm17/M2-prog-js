...
elementsArray.push(["item4", "yellow", 2.8]);
elementsArray.push(["item5", "purple", 1.2]);
elementsArray.push(["item6", "orange", 3.5]);

console.log("Updated Array after Push");
console.log(elementsArray);

elementsArray.splice(2, 1); 
